...
#------修改agent配置文件------
sed -i '93c Server=127.0.0.1,ec2-18-220-22-69.us-east-2.compute.amazonaws.com' /usr/local/etc/zabbix_agentd.conf
sed -i '134c ServerActive=ec2-18-220-22-69.us-east-2.compute.amazonaws.com:10051' /usr/local/etc/zabbix_agentd.conf
